    ...
    <div class="navbar navbar-default navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        ...
        <a class="navbar-brand" href="inicio.php">
          <img class="img-responsive logo" src="../img/menu-logo.png" width="100px" >
        </a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class=""><a href="inicio.php"><span class="glyphicon glyphicon-home"></span> Inicio</a>
            </li>
          ...
          <?php  } endif; ?>
            ...
            <li class=""><a href="ordenes.php"><span class="glyphicon glyphicon-list-alt"></span> Ordenes</a>
            </li>
            <li class=""><a href="carta.php">
            <span class="glyphicon glyphicon-cutlery"></span> Menú<span   class="">
                </span> </a>
            </li>
...
<!--        <li class="dropdown">
        ...
        <?php if($_SESSION['cargo']=='Administrador'):{ ?>
          ...
          <li>
            <a href="#"><span class="glyphicon glyphicon-usd">  </span> Ventas</a>
          </li>
        <?php } endif; ?>
